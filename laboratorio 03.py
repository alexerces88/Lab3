...
#NOMBRE: Alex Sergio Alvarez Herrera
...
class Nodo:
    #self puede acceder a sus funciones que se esta declarando 
    #hace una funcion para declarar
...
def bpa(estado_inicio, estado_solucion,tam):
    ...
    while resuelto == False and len(nodos_frontera) != 0: #len para contar los elementos de la lista 
        nodo_actual = nodos_frontera.pop(0) #pop en una lista saca el ultimo elemento y lo elimina 
